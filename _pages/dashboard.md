 ...
 <div class="row">
                ...
                <div class="col-xxl-6">
                    <div class="card top-bid">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-6"><img src="/images/items/14.jpg" class="img-fluid rounded"
                                        alt="..."></div>
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center mb-3"><img src="/images/avatar/1.jpg" alt=""
                                            class="me-3 avatar-img">
                                    ...
                                    <div class="d-flex justify-content-between mt-3 mb-3">
                                        ...
                                        <div class="text-end">
                                            <p class="mb-2">Bid : <strong class="text-primary">0.05 ETH</strong></p>
                                            <h5 class="text-muted">0.15 ETH</h5>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-center"><a href="" class="btn btn-primary">Place
                ...
                <div class="col-12">
                    <div class="filter-tab">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mb-3">Trending Bids</h4>
                            <div class="filter-nav mb-3"><a href="#" class="active">All</a><a href="#">Games</a><a
                                    href="#">Artwork</a></div>
                        </div>
                        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-4 col-md-4 col-sm-6">
                            <div class="stat-widget d-flex align-items-center">
                                ...
                                <div class="widget-arrow">
                                    <p class="text-success mb-0">+168.001% <span><i class="bi bi-arrow-up"></i></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-12 col-xl-4 col-md-4 col-sm-6">
                            <div class="stat-widget d-flex align-items-center">
                                ...
                                <div class="widget-arrow">
                                    <p class="text-danger mb-0">+168.001% <span><i class="bi bi-arrow-down"></i></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-6 col-xl-8 col-lg-6">
                    <h4 class="card-title mb-3">ETH Price</h4>
                    <div id="user-activity" class="card">
                        <div class="card-body">
                            <canvas height="280" width="670" id="activity"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class=" col-xxl-3 col-xl-4 col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <canvas height="280" width="295" id="most-selling-items"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-8 col-xl-12">
                    <h4 class="card-title mb-3">Top Creators</h4>
                    <div class="card">
                        <div class="card-body top-creators-content">
                            <div class="row">
                                <div class="col-xl-6">
                                    <div
                ...
                <div class="col-xl-12">
                    <h4 class="card-title mb-3">Recent Bid </h4>
                    <div class="bid-table">
